...
import type { OpenAIRequest, OpenAIResponse } from '../../../src/providers/openai/types'
import { createUnifiedMessage, createUnifiedRequest, createUnifiedResponse } from '../_utils/fixtures'
import { expectRequestRoundTrip, expectResponseRoundTrip, collectStreamChunks, mergeStreamChunksToResponse } from '../_utils/helpers'
...
describe('OpenAIProvider', () => {
  ...
  describe('streaming integration', () => {
    ...
    it('handles tool call streaming', () => {
      ...
      expect(parsedChunks.some(c => c.type === 'done' && c.stopReason === 'tool_use')).toBe(true)
    })
  })
})
