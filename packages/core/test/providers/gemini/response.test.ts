  ...
  describe("parseResponse (GeminiResponse → UnifiedResponse)", () => {
    ...
    describe("thinking blocks", () => {
      it("should extract thought parts to thinking array", () => {
        ...
        expect(result.thinking![0]!.text).toBe(
  ...
  describe("transformResponse (UnifiedResponse → GeminiResponse)", () => {
    ...
    describe("tool calls", () => {
      ...
      it("should transform multiple tool calls", () => {
        ...
        expect(result.candidates[0]!.content.parts[0]!.functionCall?.name).toBe(
          "tool1"
        );
        expect(result.candidates[0]!.content.parts[1]!.functionCall?.name).toBe(
          "tool2"
        );
      });
    });
    ...
    describe("thinking blocks", () => {
      it("should transform thinking to thought parts", () => {
        ...
        expect(result.candidates[0]!.content.parts[1]!.text).toBe(
          "The answer is 42."
        );
      });
