...
import type { AnthropicRequest, AnthropicResponse } from '../../../src/providers/anthropic/types'
import {
...
data: {"type":"ping"}`
  ...
  describe('Round-trip tests', () => {
    ...
    it('should handle tool calls through round-trip', () => {
      ...
      expect(roundTripped.messages[1].parts[1].toolCall?.id).toBe('toolu_test123')
    })
  })
