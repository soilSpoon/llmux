...
import { parseResponse, transformResponse } from '../../../src/providers/antigravity/response'
import type { UnifiedResponse, ContentPart, ThinkingBlock } from '../../../src/types/unified'
...
describe('Antigravity Response Transformations', () => {
  describe('parseResponse()', () => {
    ...
    describe('function call parsing', () => {
      it('should parse functionCall parts', () => {
        ...
        expect(result.content[0].toolCall?.arguments).toEqual({ location: 'NYC' })
  ...
  describe('transformResponse()', () => {
    describe('basic response transformation', () => {
      it('should transform a simple text response', () => {
        ...
        const result = transformResponse(unifiedResponse) as AntigravityResponse
      ...
      it('should transform multi-part response', () => {
        ...
        expect(result.response.candidates[0].content.parts[0].text).toBe('First part.')
        expect(result.response.candidates[0].content.parts[1].text).toBe('Second part.')
      })
    })
    ...
    describe('stop reason mapping', () => {
      ...
      it('should map content_filter to SAFETY', () => {
        const response = createUnifiedResponse({ stopReason: 'content_filter' })
        const result = transformResponse(response) as AntigravityResponse
    ...
    describe('thinking blocks transformation', () => {
      it('should transform thinking blocks with signatures', () => {
        const response = createUnifiedResponse({
          ...
          thinking: [
            { text: 'Let me analyze...', signature: 'sig123' },
          ],
        })
  ...
  describe('round-trip', () => {
    it('should preserve text content through round-trip', () => {
      ...
      const antigravityResponse = transformResponse(unifiedResponse) as AntigravityResponse
