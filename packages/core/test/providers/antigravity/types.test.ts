...
describe('Antigravity Types', () => {
  describe('AntigravityRequest', () => {
    ...
    it('should support thinkingConfig for Claude thinking models', () => {
      ...
      expect(request.request.generationConfig?.thinkingConfig?.include_thoughts).toBe(true)
      expect(request.request.generationConfig?.thinkingConfig?.thinking_budget).toBe(16384)
    })
  })
