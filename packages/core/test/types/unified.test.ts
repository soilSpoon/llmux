...
describe('ContentPart', () => {
  ...
  it('should accept thinking content', () => {
    const part: ContentPart = {
      type: 'thinking',
      thinking: { text: 'Reasoning...', signature: 'sig', signatureValid: true },
    }
...
describe('ImageData', () => {
  ...
  it('should accept URL reference', () => {
    const img: ImageData = { mimeType: 'image/png', url: 'https://example.com/img.png' }
...
describe('ToolCall', () => {
  it('should have required fields', () => {
    const call: ToolCall = { id: 'tc-1', name: 'calculate', arguments: { x: 1, y: 2 } }
...
describe('ToolResult', () => {
  ...
  it('should accept isError flag', () => {
    const result: ToolResult = { toolCallId: 'tc-1', content: 'Error occurred', isError: true }
...
describe('ThinkingBlock', () => {
  ...
  it('should accept optional signature fields', () => {
    const block: ThinkingBlock = { text: 'Reasoning', signature: 'abc123', signatureValid: false }
...
describe('ThinkingConfig', () => {
  ...
  it('should accept optional fields', () => {
    const config: ThinkingConfig = { enabled: true, budget: 50000, includeThoughts: true }
