/**
 * OpenAI Chat Response Transformations
 *
 ...
 */
export function parseResponse(response: OpenAIChatResponse): UnifiedResponse {
 ...
 */
export function transformResponse(response: UnifiedResponse): OpenAIChatResponse {
...
function parseMessageContent(message: OpenAIChatResponseMessage): ContentPart[] {
...
function parseToolCall(toolCall: OpenAIChatToolCall): ContentPart {
  return {
    type: 'tool_call',
    toolCall: {
      id: toolCall.id,
...
function transformMessage(response: UnifiedResponse): OpenAIChatResponseMessage {
  ...
  const message: OpenAIChatResponseMessage = {
    role: 'assistant',
...
function parseUsage(usage: OpenAIChatUsage): UsageInfo {
...
function transformUsage(usage: UsageInfo): OpenAIChatUsage {
  const result: OpenAIChatUsage = {
